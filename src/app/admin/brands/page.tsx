  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 ease-out">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage platform brands.</p>
      </div>
      ...
      <div className="bg-card rounded-2xl border border-border/40 overflow-hidden shadow-sm">
        <div className="p-6 border-b border-border/40">
          <form action={async (formData: FormData) => {
            ...
            <input name="name" required placeholder="New Brand Name" className="flex-1 h-10 rounded-xl border border-input bg-background px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" />
